...
// |Field title                        |no  |type  |len  |fixed |format|
    ...
    private static Map<Integer, com.imohsenb.ISO8583.enums.FIELDS> map = new HashMap<Integer, com.imohsenb.ISO8583.enums.FIELDS>();

    static {
        for (com.imohsenb.ISO8583.enums.FIELDS field : com.imohsenb.ISO8583.enums.FIELDS.values()) {
    ...
    public static com.imohsenb.ISO8583.enums.FIELDS valueOf(int no) {
        return map.get(no);
    }
}
