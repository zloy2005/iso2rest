...
public class ISOMessage {
    ...
    public static com.imohsenb.ISO8583.entities.ISOMessage NullObject() {
        return new com.imohsenb.ISO8583.entities.ISOMessage();
    }
    ...
    /**
     * Set and parse com.imohsenb.ISO8583 message from buffer
     *
     * @param message         com.imohsenb.ISO8583 in byte array format
     * @param headerAvailable set true if header is available in buffer
     * @return returns com.imohsenb.ISO8583 message in ISOMessage type
     * @throws ISOException throws exception
     */
    public com.imohsenb.ISO8583.entities.ISOMessage setMessage(byte[] message, boolean headerAvailable) throws ISOException {
     ...
     * @throws ISOException throws exception
     */
    public com.imohsenb.ISO8583.entities.ISOMessage setMessage(byte[] message) throws ISOException {
